...
const PRELOAD_ENTRY = path.join(DIST_ROOT, "preload.js");
const RENDERER_INDEX = path.join(RENDERER_ROOT, "index.html");
const RENDERER_ASSET_MANIFEST = path.join(RENDERER_ROOT, "assets", "asset-manifest.json");
const RENDERER_MANIFEST = path.join(RENDERER_ROOT, "manifest.json");
const APP_PACKAGE = path.resolve(APP_ROOT, "..", "package.json");
